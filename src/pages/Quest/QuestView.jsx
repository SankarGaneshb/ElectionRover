        ...
        {!isFinished ? (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-12">
              <div className="flex items-center gap-3 text-national-saffron">
                ...
                <span className="uppercase tracking-[0.4em] text-[10px] font-black">Active Protocol Initialization</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="md:col-span-1 space-y-4">
                ...
                >
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest">Consult Agent</span>
                </button>
                <div className="text-[10px] text-slate-600 leading-relaxed text-center px-4">
                  Need clarification on this phase? Ask the Educator Agent for deep-dive insights.
                </div>
              </div>
            </div>
                    ...
                    <div className="max-h-40 overflow-y-auto mb-3 space-y-3 pr-2 custom-scrollbar">
                      {chatHistory.length === 0 && (
                        <div className="text-center py-4 text-slate-500 text-xs italic">
                          "Protocol is active. How can I assist with your registration?"
                        </div>
                      )}
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                <span>{currentStep === quest.steps.length - 1 ? 'Terminate Protocol & Verify' : 'Proceed to Next Phase'}</span>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-6xl font-black mb-6 tracking-tighter">PROTOCOL VERIFIED</h2>
              <p className="text-2xl text-slate-400 mb-12">
                Integrity Seal: <span className="text-white font-bold">{quest.badge}</span>
              </p>
              ...
              <p className="text-xs text-slate-600 uppercase tracking-[0.5em] animate-pulse">Syncing with Electoral Roll...</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
