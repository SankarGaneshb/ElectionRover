  ...
  voter: [
    ...
    },
    {
      ...
      steps: [
        ...
        { title: "Report & Flag", content: "Learn how citizens and political party agents can submit suspicious content for verification. Understand the reporting pipeline — from a single flagged post to a clustered misinformation pattern detected by BigQuery." },
        { title: "See the Cluster", content: "Watch how BigQuery ML groups hundreds of individual reports into coordinated misinformation campaigns. The simulation shows how a single fake claim about a candidate spreads across platforms and how AI identifies the source patterns." },
        { title: "Verify with AI", content: "Gemini evaluates the flagged content against verified election commission data. See the confidence scores, source attribution, and final verdict — all powered by BigQuery ML.GENERATE_TEXT running inside SQL queries." }
      ],
      points: 75,
  ...
  candidate: [
    ...
    },
    {
      ...
      steps: [
        ...
        { title: "The Reporting Pipeline", content: "Learn how citizens, party workers, and election officials submit suspicious claims. Each report enters a BigQuery dataset where it is timestamped, geo-tagged, and source-mapped." },
        { title: "AI-Powered Cluster Detection", content: "BigQuery ML groups individual reports by content similarity, timing patterns, and geographic spread. See how 50 separate reports about a fake candidate statement get linked to a single coordinated campaign." },
