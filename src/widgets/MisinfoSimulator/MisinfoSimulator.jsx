...
import { 
  ...
  AlertTriangle, X, Globe, TrendingUp, Users, Clock, Zap, Brain, BarChart3
} from 'lucide-react';
...
const SIM_I18N = {
  ...
  te: {
    ...
    steps: [
      "అధునాతన కృత్రిమ మేధస్సు డేటాసెట్‌లో నివేదిక నమోదు చేయబడుతోంది...",
  ...
  kn: {
    ...
    steps: [
      "ಸುಧಾರಿತ ಕೃತಕ ಬುದ್ಧಿಮತ್ತೆ ಡೇಟಾಸೆಟ್‌ಗೆ ವರದಿ ದಾಖಲಿಸಲಾಗುತ್ತಿದೆ...",
  ...
  bn: {
    ...
    steps: [
      "উন্নত কৃত্রিম বুদ্ধিমত্তা ডেটাসেটে রিপোর্ট অন্তর্ভুক্ত করা হচ্ছে...",
  ...
  ml: {
    ...
    steps: [
      "നൂതന കൃത്രിമ ബുദ്ധി ഡാറ്റാസെറ്റിലേക്ക് റിപ്പോർട്ട് ഉൾപ്പെടുത്തുന്നു...",
  ...
  mr: {
    ...
    steps: [
      "प्रगत कृत्रिम बुद्धिमत्ता डेटासेटमध्ये अहवाल प्रविष्ट केला जात आहे...",
  ...
  gu: {
    ...
    steps: [
      "આધુનિક કૃત્રિમ બુદ્ધિ ડેટાસેટમાં રિપોર્ટ સામેલ કરવામાં આવી રહ્યો છે...",
  ...
  or: {
    ...
    steps: [
      "ଉନ୍ନତ କୃତ୍ରିମ ବୁଦ୍ଧିମତା ଡାಟାସେଟରେ ରିପୋର୍ଟ ଦାଖଲ କରାଯାଉଛି...",
  ...
  pa: {
    ...
    steps: [
      "ਉੱਨਤ ਆਰਟੀਫੀਸ਼ੀਅਲ ਇੰਟੈਲੀਜੈਂਸ ਡੇਟਾਸੈਟ ਵਿੱਚ ਰਿਪੋਰਟ ਦਰਜ ਕੀਤੀ ਜਾ ਰਹੀ ਹੈ...",
